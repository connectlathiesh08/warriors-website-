...
<head>
  ...
  <title>About Us | Rotaract Bangalore Warriors</title>
...
.dg-footer {
  ...
  <style>
    ...
    .timeline-node::after {
      ...
      width: 100%;
      height: 2px;
      background: repeating-linear-gradient(to right, #8B003A 0px, #8B003A 6px, transparent 6px, transparent 12px);
      z-index: 1;
...
<body class="flex min-h-screen flex-col page-texture">
  ...
  <header class="site-header sticky top-0 z-[1000] w-full shrink-0 flex items-center border-b border-transparent">
    <div class="relative flex h-full w-full items-center justify-between px-10">
      ...
      <!-- Center Navigation (Apple/Stripe Style) -->
        ...
        <a href="Default.aspx" data-nav="home" data-label="HOME" class="slot-link relative px-3.5 py-1.5 text-[14px] font-bold tracking-wide transition-colors hover:text-[#8B003A] group font-display">
        ...
        <a href="About.aspx" data-nav="about" data-label="ABOUT US" class="slot-link relative px-3.5 py-1.5 text-[14px] font-bold tracking-wide transition-colors rounded-full bg-[#8B003A] text-white hover:text-white font-display"></a>
      ...
      <div class="header-actions relative z-[2] hidden shrink-0 items-center gap-3 min-[1440px]:flex font-display"></div>
    ...
    <nav class="mobile-nav hidden border-t border-slate-100 bg-[#e0f2fe]/95 backdrop-blur-md px-6 pb-8 pt-5 min-[1440px]:hidden w-full absolute top-[70px] left-0 shadow-lg z-50">
      <ul class="flex flex-col gap-4 font-display font-bold text-slate-700">
        <li><a href="Default.aspx" data-label="HOME" class="slot-link block w-fit text-[17px] hover:text-[#8B003A]"></a></li>
        <li><a href="About.aspx" data-label="ABOUT US" class="slot-link block w-fit text-[17px] text-[#8B003A]"></a></li>
      </ul>
    </nav>
  </header>

  <!-- ============================ CONTACT STRIP ============================ -->
  <div class="relative border-b border-white/45 bg-gradient-to-b from-white/55 to-white/25 shadow-sm backdrop-blur-xl">
    <div class="relative mx-auto flex max-w-[1720px] flex-wrap items-center justify-end gap-x-2.5 gap-y-2 px-5 py-2.5 sm:px-8">
      <a href="mailto:racwarriors2023@gmail.com" class="flex items-center gap-2 rounded-full bg-white/55 px-3.5 py-1.5 text-[13px] font-medium text-slate-700 shadow-sm ring-1 ring-white/60 hover:bg-white/80 transition">
        <svg class="h-4 w-4 text-[#8B003A]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
        <span>racwarriors2023@gmail.com</span>
      </a>
      <a href="tel:+918884669102" class="flex items-center gap-2 rounded-full bg-white/55 px-3.5 py-1.5 text-[13px] font-medium text-slate-700 shadow-sm ring-1 ring-white/60 hover:bg-white/80 transition">
        <svg class="h-4 w-4 text-[#8B003A]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
        <span>+91 88846 69102</span>
      </a>
    </div>
  </div>
  ...
  <main class="flex-1 bg-[#f8fafc]">
      ...
      <div class="mx-auto max-w-[1400px] px-6 relative z-10">
        <div class="grid gap-12 lg:grid-cols-12 items-center">
          <div class="lg:col-span-6 flex flex-col items-start text-left hero-text-animate">
            <span class="text-xs font-black tracking-widest text-[#F5A623] uppercase bg-[#8B003A]/5 border border-[#8B003A]/10 px-3 py-1 rounded-full mb-4">About Us</span>
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-none">
              Together, we<br/>
              <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#8B003A] to-[#b3004b] block mt-2">Create Change</span>
            </h1>
            <p class="text-slate-600 font-medium leading-relaxed text-base mt-6 max-w-lg" id="cms-hero-desc">
              Rotaract Bangalore Warriors is a family of young changemakers committed to creating meaningful impact through service, leadership, fellowship and innovation.
            </p>
            <div class="flex flex-wrap gap-4 mt-8">
              <a href="#journey" class="flex items-center justify-center rounded-xl bg-[#8B003A] px-6 py-3 text-sm font-bold text-white shadow hover:bg-[#78002E] transition duration-200">
                Our Journey
              </a>
              <a href="https://forms.gle/BVdNJdAXn4ujKXt39" target="_blank" rel="noopener" class="flex items-center justify-center rounded-xl border border-[#8B003A] text-[#8B003A] px-6 py-3 text-sm font-bold bg-[#8B003A]/5 hover:bg-[#8B003A]/10 transition duration-200">
                Become a Warrior
              </a>
            </div>
          </div>
          <div class="lg:col-span-6 flex items-center justify-center hero-img-animate">
            <div class="relative w-full max-w-lg">
              <div class="absolute inset-0 bg-[#8B003A]/5 rounded-[30px] filter blur-xl transform scale-95 translate-y-4"></div>
              <img src="assets/img/illustrations/hero_about.png" alt="Warriors volunteering illustration" class="relative z-10 w-full h-auto object-contain rounded-[30px]" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="journey" class="py-20 bg-white overflow-hidden">
      <div class="mx-auto max-w-[1400px] px-6 text-center">
        <span class="text-[11px] font-extrabold tracking-[0.2em] text-[#8B003A] uppercase">Our Journey</span>
        <h2 class="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-2">Miles that made us stronger</h2>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-4 mt-16 relative">
          <div class="timeline-node flex flex-col items-center p-4 bg-slate-50 border border-slate-100 rounded-3xl z-10 shadow-sm hover:translate-y-[-4px] hover:shadow-md transition duration-300">
            <span class="text-xs font-black text-amber-500 tracking-wider mb-2">2023</span>
            <div class="h-12 w-12 rounded-full bg-[#8B003A]/5 border border-[#8B003A]/10 flex items-center justify-center text-lg mb-3">🌱</div>
            <h4 class="text-xs font-extrabold text-slate-800 uppercase tracking-wide text-center">The Beginning</h4>
            <span class="text-[9px] font-black text-[#8B003A] tracking-wider uppercase mt-1">The Club Was Chartered</span>
            <p class="text-[10px] font-medium text-slate-400 mt-2 text-center leading-relaxed">"The seed of Rotaract Bangalore Warriors was planted with a vision to serve, lead, and create meaningful change."</p>
          </div>
          <div class="timeline-node flex flex-col items-center p-4 bg-slate-50 border border-slate-100 rounded-3xl z-10 shadow-sm hover:translate-y-[-4px] hover:shadow-md transition duration-300">
            <span class="text-xs font-black text-amber-500 tracking-wider mb-2">2024</span>
            <div class="h-12 w-12 rounded-full bg-[#8B003A]/5 border border-[#8B003A]/10 flex items-center justify-center text-lg mb-3">🌿</div>
            <h4 class="text-xs font-extrabold text-slate-800 uppercase tracking-wide text-center">The Seed Was Planted</h4>
            <span class="text-[9px] font-black text-[#8B003A] tracking-wider uppercase mt-1">Building the Foundation</span>
            <p class="text-[10px] font-medium text-slate-400 mt-2 text-center leading-relaxed">"We established strong administrative systems, club culture, and a united team, laying the foundation for sustainable growth."</p>
          </div>
          <div class="timeline-node flex flex-col items-center p-4 bg-slate-50 border border-slate-100 rounded-3xl z-10 shadow-sm hover:translate-y-[-4px] hover:shadow-md transition duration-300">
            <span class="text-xs font-black text-amber-500 tracking-wider mb-2">2025</span>
            <div class="h-12 w-12 rounded-full bg-[#8B003A]/5 border border-[#8B003A]/10 flex items-center justify-center text-lg mb-3">🌳</div>
            <h4 class="text-xs font-extrabold text-slate-800 uppercase tracking-wide text-center">Strengthening the Roots</h4>
            <span class="text-[9px] font-black text-[#8B003A] tracking-wider uppercase mt-1">Growing Through Service</span>
            <p class="text-[10px] font-medium text-slate-400 mt-2 text-center leading-relaxed">"Our roots grew deeper through impactful projects, stronger fellowship, leadership development, and meaningful community partnerships."</p>
          </div>
          <div class="timeline-node flex flex-col items-center p-4 bg-slate-50 border border-slate-100 rounded-3xl z-10 shadow-sm hover:translate-y-[-4px] hover:shadow-md transition duration-300">
            <span class="text-xs font-black text-amber-500 tracking-wider mb-2">2026</span>
            <div class="h-12 w-12 rounded-full bg-[#8B003A]/5 border border-[#8B003A]/10 flex items-center justify-center text-lg mb-3">🌲</div>
            <h4 class="text-xs font-extrabold text-slate-800 uppercase tracking-wide text-center">The Stem Emerges</h4>
            <span class="text-[9px] font-black text-[#8B003A] tracking-wider uppercase mt-1">Standing Tall Together</span>
            <p class="text-[10px] font-medium text-slate-400 mt-2 text-center leading-relaxed">"With a strong foundation, the club entered a new era of growth, expanding its impact and reaching greater heights through innovation and service."</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 bg-[#8B003A]/5 border-y border-[#8B003A]/5">
      <div class="mx-auto max-w-[1400px] px-6 text-center">
        <span class="text-[11px] font-extrabold tracking-[0.2em] text-[#8B003A] uppercase">Our Impact</span>
        <h2 class="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-1">Turning small actions into big impact</h2>
        
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5 mt-12">
          <div class="bg-white border border-[#8B003A]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm hover:scale-[1.02] hover:shadow transition">
            <span class="text-xl mb-2">📝</span>
            <span class="text-[20px] font-black text-slate-850 leading-tight block">484+</span>
            <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider text-center mt-1">Projects Completed</span>
          </div>
          <div class="bg-white border border-[#8B003A]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm hover:scale-[1.02] hover:shadow transition">
            <span class="text-xl mb-2">❤️</span>
            <span class="text-[20px] font-black text-slate-850 leading-tight block">10,000+</span>
            <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider text-center mt-1">Lives Impacted</span>
          </div>
          <div class="bg-white border border-[#8B003A]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm hover:scale-[1.02] hover:shadow transition">
            <span class="text-xl mb-2">🌳</span>
            <span class="text-[20px] font-black text-slate-850 leading-tight block">100+</span>
            <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider text-center mt-1">Plants Planted</span>
          </div>
          <div class="bg-white border border-[#8B003A]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm hover:scale-[1.02] hover:shadow transition">
            <span class="text-xl mb-2">🍲</span>
            <span class="text-[20px] font-black text-slate-850 leading-tight block">2,500+</span>
            <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider text-center mt-1">Meals Served</span>
          </div>
          <div class="bg-white border border-[#8B003A]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm hover:scale-[1.02] hover:shadow transition">
            <span class="text-xl mb-2">🩸</span>
            <span class="text-[20px] font-black text-slate-850 leading-tight block">350+</span>
            <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider text-center mt-1">Blood Units Collected</span>
          </div>
          <div class="bg-white border border-[#8B003A]/10 rounded-2xl p-5 flex flex-col items-center shadow-sm hover:scale-[1.02] hover:shadow transition">
            <span class="text-xl mb-2">🎓</span>
            <span class="text-[20px] font-black text-slate-850 leading-tight block">300+</span>
            <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider text-center mt-1">Students Supported</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-white">
      <div class="mx-auto max-w-[1400px] px-6 text-center">
        <span class="text-[11px] font-extrabold tracking-[0.2em] text-[#8B003A] uppercase">What We Do</span>
        <h2 class="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-2">Areas of our Service</h2>
        
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
          <div class="flex flex-col items-center p-6 border rounded-3xl shadow-sm hover:scale-[1.01] hover:shadow-md transition duration-300 bg-red-500/5 border-red-500/10">
            <div class="h-14 w-14 rounded-full bg-white flex items-center justify-center text-2xl shadow-sm mb-4">🩸</div>
            <h4 class="text-sm font-black text-slate-800 uppercase tracking-wide">Blood Donation</h4>
            <p class="text-xs text-slate-450 mt-2 leading-relaxed text-center font-semibold">Organizing blood donation drives and saving lives.</p>
          </div>
          <div class="flex flex-col items-center p-6 border rounded-3xl shadow-sm hover:scale-[1.01] hover:shadow-md transition duration-300 bg-emerald-500/5 border-emerald-500/10">
            <div class="h-14 w-14 rounded-full bg-white flex items-center justify-center text-2xl shadow-sm mb-4">🌳</div>
            <h4 class="text-sm font-black text-slate-800 uppercase tracking-wide">Tree Plantation</h4>
            <p class="text-xs text-slate-450 mt-2 leading-relaxed text-center font-semibold">Creating a greener tomorrow through plantation drives.</p>
          </div>
          <div class="flex flex-col items-center p-6 border rounded-3xl shadow-sm hover:scale-[1.01] hover:shadow-md transition duration-300 bg-blue-500/5 border-blue-500/10">
            <div class="h-14 w-14 rounded-full bg-white flex items-center justify-center text-2xl shadow-sm mb-4">🏥</div>
            <h4 class="text-sm font-black text-slate-800 uppercase tracking-wide">Health Camps</h4>
            <p class="text-xs text-slate-450 mt-2 leading-relaxed text-center font-semibold">Medical camps and health awareness programs.</p>
          </div>
          <div class="flex flex-col items-center p-6 border rounded-3xl shadow-sm hover:scale-[1.01] hover:shadow-md transition duration-300 bg-indigo-500/5 border-indigo-500/10">
            <div class="h-14 w-14 rounded-full bg-white flex items-center justify-center text-2xl shadow-sm mb-4">📚</div>
            <h4 class="text-sm font-black text-slate-800 uppercase tracking-wide">Education</h4>
            <p class="text-xs text-slate-450 mt-2 leading-relaxed text-center font-semibold">Supporting education for children and empowering youth.</p>
          </div>
          <div class="flex flex-col items-center p-6 border rounded-3xl shadow-sm hover:scale-[1.01] hover:shadow-md transition duration-300 bg-teal-500/5 border-teal-500/10">
            <div class="h-14 w-14 rounded-full bg-white flex items-center justify-center text-2xl shadow-sm mb-4">🧹</div>
            <h4 class="text-sm font-black text-slate-800 uppercase tracking-wide">Environment</h4>
            <p class="text-xs text-slate-450 mt-2 leading-relaxed text-center font-semibold">Cleanliness drives, plastic-free initiatives and more.</p>
          </div>
          <div class="flex flex-col items-center p-6 border rounded-3xl shadow-sm hover:scale-[1.01] hover:shadow-md transition duration-300 bg-amber-500/5 border-amber-500/10">
            <div class="h-14 w-14 rounded-full bg-white flex items-center justify-center text-2xl shadow-sm mb-4">🎓</div>
            <h4 class="text-sm font-black text-slate-800 uppercase tracking-wide">Youth Leadership</h4>
            <p class="text-xs text-slate-450 mt-2 leading-relaxed text-center font-semibold">Building confident leaders through training and events.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Section 8: Why Join Us (Volunteer banner) -->
    <section class="relative bg-gradient-to-r from-[#8B003A] to-[#6e002e] py-20 text-white overflow-hidden">
      <div class="pointer-events-none absolute -left-12 -top-12 h-64 w-64 rounded-full bg-white/5 blur-xl"></div>
      <div class="mx-auto max-w-[1400px] px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        <div class="text-left max-w-xl">
          <span class="text-xs font-black tracking-widest text-[#F5A623] uppercase">Be Part of Our Journey</span>
          <h2 class="text-3xl sm:text-4xl font-extrabold mt-2 leading-none">Be a Warrior. Create Change.</h2>
          <p class="text-white/80 font-medium text-sm mt-4">
            Join us in our mission to create a better society. Together, we can make a lasting difference in the community and develop leadership capabilities.
          </p>
        </div>
        <div class="shrink-0">
          <a href="https://forms.gle/BVdNJdAXn4ujKXt39" target="_blank" rel="noopener" class="flex items-center justify-center rounded-xl bg-[#F5A623] hover:bg-[#e0951b] px-8 py-4 text-sm font-bold text-white shadow-lg transition transform hover:scale-[1.02]">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 lg:gap-8 items-start">
        ...
        <div class="flex flex-col items-start gap-4 w-full">
          ...
          <ul class="grid grid-cols-2 gap-y-2.5 gap-x-4 text-xs font-bold text-slate-600 w-full">
            <li>
              <a href="Default.aspx" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                Home
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="About.aspx" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                About Us
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="DistrictCommittee.aspx" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                Warriors Council
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="Projects.aspx" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                Projects
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="Events.html" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                Events
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="Gallery.html" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                Gallery
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="Contact.html" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                Contact Us
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="https://forms.gle/BVdNJdAXn4ujKXt39" target="_blank" rel="noopener" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                Become a Warrior
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="admin.html" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                Admin Portal
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
            <li>
              <a href="https://my.rotary.org/en/login" target="_blank" rel="noopener" class="hover:text-[#8B003A] transition-colors duration-200 relative group py-0.5 inline-block">
                RI Login
                <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#8B003A] transition-all duration-300 group-hover:w-full"></span>
              </a>
            </li>
  ...
  <script src="js/about-loader.js?v=1"></script>
  <script>
